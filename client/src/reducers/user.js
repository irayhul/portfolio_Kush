...
export const updateReducer = createReducer(
  {},
  {
    ...
    ADD_WEIGHT_REQUEST: (state) => {
      state.loading = true;
    },
    ADD_WEIGHT_SUCCESS: (state, action) => {
      state.loading = false;
      state.message = action.payload;
    },
    ADD_WEIGHT_FAILURE: (state, action) => {
      state.loading = false;
      state.error = action.payload;
    },
    DELETE_WEIGHT_REQUEST: (state) => {
      state.loading = true;
    },
    DELETE_WEIGHT_SUCCESS: (state, action) => {
      state.loading = false;
      state.message = action.payload;
    },
    DELETE_WEIGHT_FAILURE: (state, action) => {
      state.loading = false;
      state.error = action.payload;
    },
    ADD_GALLERY_REQUEST: (state) => {
      state.loading = true;
    },
    ADD_GALLERY_SUCCESS: (state, action) => {
      state.loading = false;
      state.message = action.payload;
    },
    ADD_GALLERY_FAILURE: (state, action) => {
      state.loading = false;
      state.error = action.payload;
    },
    DELETE_GALLERY_REQUEST: (state) => {
      state.loading = true;
    },
    DELETE_GALLERY_SUCCESS: (state, action) => {
      state.loading = false;
      state.message = action.payload;
    },
    DELETE_GALLERY_FAILURE: (state, action) => {
      state.loading = false;
      state.error = action.payload;
    },
